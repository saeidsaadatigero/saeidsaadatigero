...
👋 Hi, I'm **Saeid Saadatigero**, a results-driven Engineer based in Iran with **3+ years of experience** building scalable web systems and production-grade AI models. I specialize in bridging the gap between complex AI research and robust Backend architecture.

---

### 🛠️ Professional Expertise
* **Backend Ecosystem:** Expert in **Django & DRF**, designing microservices for financial platforms, and managing high-traffic APIs with **Redis, Celery, and PostgreSQL**.
* **Artificial Intelligence:** Deep experience in **NLP** (Transformers, LLMs) and **Computer Vision** (YOLO, OCR).
* **Algorithmic Trading:** Developing autonomous trading bots (RL/PPO) for **XAUUSD** and integrating with **MT5 API**.
* **DevOps:** Streamlining deployments using **Docker, CI/CD pipelines, and Linux (VPS)**.
...
* An automated trading system with an **AI filter** for trade approval, optimized for the gold market.
